        ...
        <section className='contenedor-detalles'>
          ...
          >
            ...
            <div>
              ...
              <img className='imgAvion' src={avionN} alt='' />
              <p className='detalles-stop'>1 stop</p>
            </div>
            <div className='detalles-precio'>
              <h1 className='precio'>275.5 USD </h1>{' '}
          ...
          <div className='contenedor-cloudy'>
            ...
            <div className='detalles-precio'>
              <h1 className='precio'>148.5 USD </h1>{' '}
              <p className='pax'>/ pax</p>
              <button className='choose'>Choose</button>
            </div>
          </div>
          <div className='contenedor-typical'>
            ...
            <p className='textprice'> Price history </p>{' '}
            <img
              className='flecha_price'
              src={flechaDespliegue}
              alt='flecha_price'
            />
          </div>
          <div className='contenedor-cloudy2'>
            ...
            <div className='detalles-precio'>
              <h1 className='precio'>380.15 USD </h1>{' '}
              <p className='pax'>/ pax</p>
              <button className='choose'>Choose</button>
            </div>
          </div>
          <div className='contenededor-altitud2'>
            ...
            <div>
              <img className='imgLinea' src={lineaGradual} alt='' />
              <img className='imgAvion' src={avionN} alt='' />
              <p className='detalles-stop'>2 stop</p>
            </div>
            <div className='detalles-precio'>
              <h1 className='precio'>269.10 USD </h1>{' '}
              <p className='pax'>/ pax</p>
              <button className='choose'>Choose</button>
            </div>
          </div>
